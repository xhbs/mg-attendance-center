 ...
 * @lastTime: 2021-07-12 14:01:21
 * @文件相对于项目的路径: \biz-scene-attendancesys-fe\src\pages\askForLeave\ApplyToSchool\utils\tableOptions.jsx
 * @Description: 表格配置项
 */
...
import { LEAVE_TYPE, LEAVE_STATUS, DATE_TYPE, DATE_TYPE_DAY } from '@constants';
    ...
    return [
        {
            ...
            width: '8%',
            render: text => {
                const target = LEAVE_STATUS.find(item => text === item.code) || {};
        ...
        //                     }}
        //                     onClick={() => { status === 1 && handleReport(record.id) }}
        //                 >
        //                     上报
        //                 </span>
        //                 <span
        ...
        //                         cursor: status !== 1 && 'not-allowed',
        //                     }}
        //                     onClick={() => { status === 1 && handleDel(record.id) }}
        //                 >
        //                     删除
        //                 </span>
        //             </>
